...
FileStore_setPredecessor_args::~FileStore_setPredecessor_args() throw() {
}


uint32_t FileStore_setPredecessor_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t FileStore_setPredecessor_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileStore_setPredecessor_args");
...
FileStore_setPredecessor_pargs::~FileStore_setPredecessor_pargs() throw() {
}


uint32_t FileStore_setPredecessor_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FileStore_setPredecessor_pargs");
...
FileStore_setPredecessor_result::~FileStore_setPredecessor_result() throw() {
}


uint32_t FileStore_setPredecessor_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t FileStore_setPredecessor_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("FileStore_setPredecessor_result");
...
FileStore_setPredecessor_presult::~FileStore_setPredecessor_presult() throw() {
}


uint32_t FileStore_setPredecessor_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void FileStoreClient::setPredecessor(const NodeID& node)
{
  send_setPredecessor(node);
  recv_setPredecessor();
}

void FileStoreClient::send_setPredecessor(const NodeID& node)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("setPredecessor", ::apache::thrift::protocol::T_CALL, cseqid);

  FileStore_setPredecessor_pargs args;
  args.node = &node;
  args.write(oprot_);
...
void FileStoreClient::recv_setPredecessor()
{
  ...
  if (fname.compare("setPredecessor") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  FileStore_setPredecessor_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void FileStoreProcessor::process_setPredecessor(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("FileStore.setPredecessor", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "FileStore.setPredecessor");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "FileStore.setPredecessor");
  }

  FileStore_setPredecessor_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "FileStore.setPredecessor", bytes);
  }

  FileStore_setPredecessor_result result;
  try {
    iface_->setPredecessor(args.node);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "FileStore.setPredecessor");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("setPredecessor", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "FileStore.setPredecessor");
  }

  oprot->writeMessageBegin("setPredecessor", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "FileStore.setPredecessor", bytes);
  }
}
...
void FileStoreConcurrentClient::readFile(RFile& _return, const std::string& filename, const UserID& owner)
{
  int32_t seqid = send_readFile(filename, owner);
  recv_readFile(_return, seqid);
}

int32_t FileStoreConcurrentClient::send_readFile(const std::string& filename, const UserID& owner)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("readFile", ::apache::thrift::protocol::T_CALL, cseqid);
...
void FileStoreConcurrentClient::setPredecessor(const NodeID& node)
{
  int32_t seqid = send_setPredecessor(node);
  recv_setPredecessor(seqid);
}

int32_t FileStoreConcurrentClient::send_setPredecessor(const NodeID& node)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("setPredecessor", ::apache::thrift::protocol::T_CALL, cseqid);
...
void FileStoreConcurrentClient::recv_setPredecessor(const int32_t seqid)
{
